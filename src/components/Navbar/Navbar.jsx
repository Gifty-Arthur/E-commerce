...
const Navbar = () => {
  return (
    <div className='shadow-md bg-white dark:bg-gray-900 dark:text-white transition-all 
    duration-200 relative z-40'>
        ...
        <div className='bg-primary/40 py-2'>
            ...
            justify-between items-center'>
                ...
                {/*search bar*/}
                <div className='flex justify-betweemn'>
        ...
        <div className='flex justify-center'>
            <ul className='sm:flex hidden item-center
            gap-4'>
